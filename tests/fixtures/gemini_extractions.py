...
Sources (Gemini 5c):
- GkNexus: Goalkeeper training session (Screens 1 & 5 only)
...
# ---------------------------------------------------------------------------
# GkNexus — Goalkeeper Training (Screen 1: Warm-Up, Screen 5: Game Scenario)
# ---------------------------------------------------------------------------
GEMINI_GKNEXUS: dict = {
    "id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    "metadata": {
        "title": "GkNexus Goalkeeper Session",
    ...
    "drills": [
        {
            ...
            "name": "Screen 1: Warm-Up — Handling & Footwork",
            "drill_type": "Warm-Up",
            "directional": False,
            "setup": {
                "description": "GK works with coach. 6 cones arranged in a "
                "zigzag pattern. GK performs footwork through cones then "
                "receives service from coach.",
                "player_count": "1 GK + 1 Coach",
                "equipment": ["6 cones", "10 balls"],
            ...
            "diagram": {
                ...
                "player_positions": [
                    ...
                    {"label": "C", "x": 50.0, "y": 60.0, "role": "neutral"},
                ],
                "pitch_view": {
                ...
                "equipment": [
                    {"equipment_type": "cone", "x": 40.0, "y": 20.0},
                    {"equipment_type": "cone", "x": 60.0, "y": 20.0},
                    {"equipment_type": "cone", "x": 35.0, "y": 30.0},
                    {"equipment_type": "cone", "x": 65.0, "y": 30.0},
                    {"equipment_type": "cone", "x": 40.0, "y": 40.0},
            ...
            "sequence": [
                "GK starts at the near post position",
                "Footwork through zigzag cones",
                "Set position at the end cone",
                "Coach serves ball — GK makes save",
                "GK distributes ball back to coach",
                "Repeat from opposite side",
            ],
            "rules": [],
            "scoring": [],
            "coaching_points": [
                "Light feet through cones — stay on toes",
                "Set position before the serve",
                "Hands in ready position, W-shape catch",
            ],
            "progressions": [
                "Increase serve speed",
                "Add dive saves at end of footwork",
            ],
        },
        {
            "id": "b2c3d4e5-f6a7-8901-cdef-123456789012",
            "name": "Screen 5: 6-Server Bombardment",
            "drill_type": "Game-Related Practice",
            "directional": True,
            "setup": {
                "description": "6 servers positioned in an arc around the "
                "penalty area. Each server has balls. GK faces rapid-fire "
                "shots from different angles. Recovery between saves is key.",
                "player_count": "1 GK + 6 Servers",
                "equipment": ["2 mini goals", "30 balls", "6 cones"],
            ...
            "diagram": {
                ...
                "player_positions": [
                    ...
                    {"label": "S1", "x": 15.0, "y": 55.0, "role": "neutral"},
                    {"label": "S2", "x": 30.0, "y": 65.0, "role": "neutral"},
                    {"label": "S3", "x": 45.0, "y": 70.0, "role": "neutral"},
                    {"label": "S4", "x": 55.0, "y": 70.0, "role": "neutral"},
                    {"label": "S5", "x": 70.0, "y": 65.0, "role": "neutral"},
                    {"label": "S6", "x": 85.0, "y": 55.0, "role": "neutral"},
                ],
                "pitch_view": {
                    "view_type": "penalty_area",
                    "orientation": "vertical",
                ...
                "equipment": [
                    {"equipment_type": "cone", "x": 15.0, "y": 55.0},
                    {"equipment_type": "cone", "x": 30.0, "y": 65.0},
                    {"equipment_type": "cone", "x": 45.0, "y": 70.0},
                    {"equipment_type": "cone", "x": 55.0, "y": 70.0},
                    {"equipment_type": "cone", "x": 70.0, "y": 65.0},
                    {"equipment_type": "cone", "x": 85.0, "y": 55.0},
                ],
                "goals": [
            ...
            "sequence": [
                "S1 shoots from wide left angle",
                "GK saves and recovers to set position",
                "S2 shoots from half-left",
                "Continue around the arc S3 through S6",
                "Rest 60 seconds then repeat",
            ],
            "rules": [
                "Servers wait for GK to be set before shooting",
                "Shots must be on target",
            ],
            "scoring": [
                "GK scores 1 point per save",
                "Bonus point for clean catch (no parry)",
            ],
            "coaching_points": [
                "Recover to central position after each save",
                "Adjust angle to the ball — arc positioning",
                "Stay balanced, do not dive early",
                "Quick feet to reset between saves",
            ],
            "progressions": [
                "Reduce recovery time between shots",
                "Servers can fake and pass to next server",
                "Add a rebound follow-up from S3 or S4",
            ],
        },
    ],
    "source": {
        "filename": "GkNexus_GK_Session.pdf",
        "page_count": 8,
